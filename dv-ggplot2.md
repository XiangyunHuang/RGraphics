...
**ggrastr**             Raster Layers for ggplot2                                                                  
...
#> 
#> Package version:
#>   assertthat_0.2.1   backports_1.1.8    beeswarm_0.2.3    
#>   callr_3.4.3        cli_2.0.2          colorspace_1.4-1  
#>   crayon_1.3.4       desc_1.2.0         digest_0.6.25     
#>   ellipsis_0.3.1     evaluate_0.14      fansi_0.4.1       
#>   farver_2.0.3       ggbeeswarm_0.6.0   ggplot2_3.3.2     
#>   ggridges_0.5.2     glue_1.4.1         graphics_4.0.0    
#>   grDevices_4.0.0    grid_4.0.0         gtable_0.3.0      
#>   hexbin_1.28.1      isoband_0.2.2      labeling_0.3      
#>   lattice_0.20.41    lifecycle_0.2.0    magrittr_1.5      
#>   MASS_7.3.51.5      Matrix_1.2.18      methods_4.0.0     
#>   mgcv_1.8-31        munsell_0.5.0      nlme_3.1-147      
#>   pillar_1.4.4       pkgbuild_1.0.8     pkgconfig_2.0.3   
#>   pkgload_1.1.0      plyr_1.8.6         praise_1.0.0      
#>   prettyunits_1.1.1  processx_3.4.3     ps_1.3.3          
#>   R6_2.4.1           RColorBrewer_1.1.2 Rcpp_1.0.5        
#>   rlang_0.4.6        rprojroot_1.3.2    rstudioapi_0.11   
#>   scales_1.1.1       splines_4.0.0      stats_4.0.0       
#>   testthat_2.3.2     tibble_3.0.1       tools_4.0.0       
#>   utf8_1.1.4         utils_4.0.0        vctrs_0.3.1       
#>   vipor_0.4.5        viridisLite_0.3.0  withr_2.2.0
```
