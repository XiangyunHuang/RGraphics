...
subset(pdb, subset = grepl(x = pdb[, "Maintainer"], pattern = "(Paul Murrell)"), 
                   select = c("Package", "Maintainer"))
#>            Package                              Maintainer
#> 2084       compare Paul Murrell <p.murrell@auckland.ac.nz>
#> 5277    graphicsQC Paul Murrell <paul@stat.auckland.ac.nz>
#> 5310      gridBase Paul Murrell <paul@stat.auckland.ac.nz>
#> 5311    gridBezier Paul Murrell <paul@stat.auckland.ac.nz>
#> 5312     gridDebug Paul Murrell <p.murrell@auckland.ac.nz>
#> 5314  gridGeometry Paul Murrell <paul@stat.auckland.ac.nz>
#> 5315  gridGraphics Paul Murrell <paul@stat.auckland.ac.nz>
#> 5316  gridGraphviz Paul Murrell <p.murrell@auckland.ac.nz>
#> 5319       gridSVG Paul Murrell <paul@stat.auckland.ac.nz>
....
```
...
MASS      Brian Ripley   2019-04-26 
tree      Brian Ripley   2019-04-26 
boot      Brian Ripley   2019-07-05 
...
#> [17] "haven"         "hflights"      "httr"          "lazyeval"     
#> [21] "lobstr"        "lvplot"        "meifly"        "modelr"       
#> [25] "nasaweather"   "nycflights13"  "pkgdown"       "plyr"         
#> [29] "productplots"  "profr"         "proto"         "pryr"         
#> [33] "rappdirs"      "reshape"       "reshape2"      "rggobi"       
#> [37] "roxygen2"      "rvest"         "scales"        "sloop"        
#> [41] "stringr"       "testthat"      "tidyr"         "tidyverse"    
#> [45] "vctrs"
```
...
#>             Package                             Maintainer
#> 504      assertthat    Hadley Wickham <hadley@rstudio.com>
#> 634       babynames    Hadley Wickham <hadley@rstudio.com>
#> 1014      bigrquery    Hadley Wickham <hadley@rstudio.com>
#> 1818      classifly   Hadley Wickham <h.wickham@gmail.com>
#> 1902     clusterfly   Hadley Wickham <h.wickham@gmail.com>
#> 2154     conflicted    Hadley Wickham <hadley@rstudio.com>
#> 2689         dbplyr    Hadley Wickham <hadley@rstudio.com>
#> 3191          dplyr    Hadley Wickham <hadley@rstudio.com>
#> 3277         dtplyr    Hadley Wickham <hadley@rstudio.com>
....
```
...
#> 2741 1166  733  447  197  115   74   49   28   25    8    8    4    4    2 
#>   16   17   18   19   21   22   27   41 
#>    5    3    1    1    3    2    2    1
```
...
#>   BH_1.69.0.1        bookdown_0.15      cli_1.1.0         
#>   codetools_0.2-16   colorspace_1.4-2   compiler_4.0.0    
#>   crayon_1.3.4       curl_4.2           digest_0.6.22     
#>   dplyr_0.8.3        ellipsis_0.3.0     evaluate_0.14     
#>   fansi_0.4.0        ggplot2_3.2.1      glue_1.3.1        
