...
```{sql mtcars, connection=con, cache = FALSE, tab.cap = "表格标题",eval=FALSE}
...
```{sql mtcars2, connection=con, cache = TRUE, output.var = "agg_cyl", ref.label = "mtcars", echo=FALSE,eval=FALSE}
```
```{r,eval=FALSE}
agg_cyl
```
...
knitr::include_graphics(path = "figures/spark-start.png")
```
...
knitr::include_graphics(path = "figures/spark-mtcars.png")
```
...
knitr::include_graphics(path = 'figures/dm-batch-export-xlsx.png')
```
