...
write.table(maintainer_author,file = "maintainer_author.csv", row.names = TRUE, col.names = TRUE)
```
```{r,echo=FALSE}
...
```{r}
# 贡献者最多的 R 包有 62 名，这个 R 包的粉丝真的是多
max(rowSums(maintainer_author))
# 有一个开发者对 137 个 R 包的做出过贡献，其中包括自己开发的 R 包
# 快来快来抓住他
