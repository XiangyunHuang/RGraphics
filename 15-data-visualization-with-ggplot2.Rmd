...
二维的图例 [biscale](https://github.com/slu-openGIS/biscale) 
...
[ggExtra](https://github.com/daattali/ggExtra) 在图的边界添加密度估计曲线，直方图
...
```
```{r,echo=FALSE}
knitr::include_graphics(path = "figures/ggplot2-density-2d.png")
```
