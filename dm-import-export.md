...
searchpaths()
#> [1] ".GlobalEnv"                                
#> [2] "/home/travis/R-bin/lib/R/library/stats"    
#> [3] "/home/travis/R-bin/lib/R/library/graphics" 
#> [4] "/home/travis/R-bin/lib/R/library/grDevices"
#> [5] "/home/travis/R-bin/lib/R/library/utils"    
#> [6] "/home/travis/R-bin/lib/R/library/datasets" 
#> [7] "/home/travis/R-bin/lib/R/library/methods"  
#> [8] "Autoloads"                                 
#> [9] "/home/travis/R-bin/lib/R/library/base"
# 返回匹配结果及其所在路径的编号
...
cat("TITLE extra line", "2 3 5 7", "", "11 13 17", file = fil,
    sep = "\n")
fil
#> [1] "/tmp/RtmpE65xM0/file46346f2be37f.data"
```
...
fil
#> [1] "/tmp/RtmpE65xM0/test46344517c33e"
readLines(fil)
#> [1] "123" "abc"
```
...
#> [13] "dv-plot3d.Rmd"              "dv-colors-fonts.Rmd"       
#> [15] "dv-spatio-temporal.Rmd"     "cs-cran-network.Rmd"       
#> [17] "99-references.Rmd"
```
...
#> [1,] "splines" "4.0.0" "Regression Spline Functions and Classes"
```
...
得益于 knitr [@xie_2015_knitr] 开发的钩子，这里直接写 SQL 语句块，打印出来见表 \@ref(tab:mtcars)，值得注意的是 SQL 代码块不能启用缓存，数据库连接通道也不能缓存，如果数据库中还没有写入表，那么写入表的操作也不能缓存， `tab.cap = "表格标题"` 输出的内容是一个表格
...
<img src="figures/spark-start.png" alt="Spark Web 接口" width="70%" />
...
<div class="figure" style="text-align: center">
<img src="figures/spark-mtcars.png" alt="数据聚合和可视化" width="70%" />
