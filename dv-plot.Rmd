...
```{r mai-oma,echo=FALSE,fig.cap="内边空和外边空",out.width="35%",fig.align='center',fig.ncol=2,fig.width=3}
knitr::include_graphics(path = system.file("help/figures/mai.png", package = "graphics"))
knitr::include_graphics(path = system.file("help/figures/oma.png", package = "graphics"))
```
