...
#>   s()  22.983  27.1495  70.23644  35.0755  38.874 3233.949   100
#>   d() 221.659 230.4750 272.06127 234.2675 244.452 3108.289   100
```
...
#>  [1] "bayesplot"   "boot"        "checkmate"   "DT"          "dygraphs"   
#>  [6] "gdtools"     "gtools"      "inline"      "loo"         "matrixStats"
#> [11] "minqa"       "mnormt"      "nloptr"      "packrat"     "pkgbuild"   
#> [16] "rsconnect"   "rstantools"  "shinystan"   "shinythemes" "StanHeaders"
#> [21] "survival"    "systemfonts" "threejs"     "xts"         "zoo"
```
...
#>   base64enc_0.1.3    BH_1.69.0.1        bookdown_0.13     
#>   broom_0.5.2        callr_3.3.1        cellranger_1.1.0  
#>   cli_1.1.0          clipr_0.7.0        codetools_0.2-16  
#>   colorspace_1.4-1   compiler_3.6.1     crayon_1.3.4      
#>   curl_4.0           DBI_1.0.0          dbplyr_1.4.2      
#>   desc_1.2.0         digest_0.6.20      dplyr_0.8.3       
#>   ellipsis_0.2.0.1   evaluate_0.14      fansi_0.4.0       
#>   forcats_0.4.0      fs_1.3.1           generics_0.0.2    
#>   ggplot2_3.2.1      glue_1.3.1         graphics_3.6.1    
#>   grDevices_3.6.1    grid_3.6.1         gtable_0.3.0      
#>   haven_2.1.1        highr_0.8          hms_0.5.1         
#>   htmltools_0.3.6    httr_1.4.1         jsonlite_1.6      
#>   knitr_1.24         labeling_0.3       lattice_0.20-38   
#>   lazyeval_0.2.2     lifecycle_0.1.0    lubridate_1.7.4   
#>   magrittr_1.5       markdown_1.1       MASS_7.3.51.4     
#>   Matrix_1.2.17      methods_3.6.1      mgcv_1.8.28       
#>   mime_0.7           modelr_0.1.5       munsell_0.5.0     
#>   nlme_3.1-141       openssl_1.4.1      pillar_1.4.2      
#>   pkgconfig_2.0.2    plogr_0.2.0        plyr_1.8.4        
#>   prettyunits_1.0.2  processx_3.4.1     progress_1.2.2    
#>   ps_1.3.0           purrr_0.3.2        R6_2.4.0          
#>   RColorBrewer_1.1.2 Rcpp_1.0.2         readr_1.3.1       
#>   readxl_1.3.1       rematch_1.0.1      reprex_0.3.0      
#>   reshape2_1.4.3     rlang_0.4.0        rmarkdown_1.15    
#>   rprojroot_1.3-2    rstudioapi_0.10    rvest_0.3.4       
...
#>   vctrs_0.2.0        viridisLite_0.3.0  whisker_0.4       
#>   withr_2.1.2        xfun_0.9           xml2_1.2.2        
