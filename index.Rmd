...
::: warning
这本书还处于一个很早期的阶段，很多代码有待替换和改进，特别是部分代码和例子直接从网上复制，这部分肯定会被替换掉
:::
...
书籍同时使用 [Github Pages](https://pages.github.com/) 和 [bookdown.org](https://bookdown.org) 以及 [netlify](https://www.netlify.com) 部署，网址分别是 <https://xiangyunhuang.github.io/RGraphics/> 和 <https://bookdown.org/xiangyun/RGraphics/> 以及 <https://r-graphics.netlify.com/>
